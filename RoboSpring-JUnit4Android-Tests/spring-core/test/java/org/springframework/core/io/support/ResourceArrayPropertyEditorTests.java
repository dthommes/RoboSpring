...
public class ResourceArrayPropertyEditorTests {
	...
	public void testVanillaResource() throws Exception {
		...
		editor.setAsText("classpath:org/springframework/core/io/example.properties");
	...
	@Test
	@Ignore("RoboSpring: Fails on Android")
	public void testPatternResource() throws Exception {
		...
		PropertyEditor editor = new ResourceArrayPropertyEditor();
		editor.setAsText("classpath*:org/springframework/core/io/support/*.properties");
		Resource[] resources = (Resource[]) editor.getValue();
		assertNotNull(resources);
		assertTrue(resources[0].exists());
	}
