...
public class PathMatchingResourcePatternResolverTests {
	...
	@Test
	@Ignore("RoboSpring: Protocol is always jar on Android")
	public void testSingleResourceOnFileSystem() throws IOException {
		Resource[] resources =
				resolver.getResources("org/springframework/core/io/example.properties");
		assertEquals(1, resources.length);
		assertProtocolAndFilename(resources[0], "file", "example.properties");
	}

	@Test
	public void testSingleResourceInJar() throws IOException {
		Resource[] resources = resolver.getResources("org/springframework/core/io/example.properties");
		assertEquals(1, resources.length);
		assertProtocolAndFilename(resources[0], "jar", "example.properties");
	}

	@Ignore("passes under eclipse, fails under ant") // passes under eclipse, fails under ant
	@Test
	...
	@Test
	@Ignore("RoboSpring: Jars don't exist within the DalvikVM")
