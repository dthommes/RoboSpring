 ...
 * @see MockEnvironment
 */
public class MockPropertySourceX extends PropertiesPropertySource {
	 ...
	 */
	public MockPropertySourceX(String name) {
	 ...
	 */
	public MockPropertySourceX(Properties properties) {
	 ...
	 * @param properties the properties to use
	 */
	public MockPropertySourceX(String name, Properties properties) {
	 ...
	 */
	public MockPropertySourceX withProperty(String name, Object value) {
