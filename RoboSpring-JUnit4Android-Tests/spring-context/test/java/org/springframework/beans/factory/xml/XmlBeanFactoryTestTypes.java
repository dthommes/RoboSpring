...
class ConstructorDependenciesBeanX implements Serializable {
	...
	public ConstructorDependenciesBeanX(int age) {
		this.age = age;
	}

	public ConstructorDependenciesBeanX(String name) {
		this.name = name;
	}

	public ConstructorDependenciesBeanX(TestBean spouse1) {
		this.spouse1 = spouse1;
	}

	public ConstructorDependenciesBeanX(TestBean spouse1, TestBean spouse2) {
		this.spouse1 = spouse1;
		this.spouse2 = spouse2;
	}

	public ConstructorDependenciesBeanX(TestBean spouse1, TestBean spouse2, IndexedTestBean other) {
		this.spouse1 = spouse1;
		this.spouse2 = spouse2;
		this.other = other;
	}
 ...
 */
@SuppressWarnings("serial")
class DerivedConstructorDependenciesBean extends ConstructorDependenciesBeanX {
