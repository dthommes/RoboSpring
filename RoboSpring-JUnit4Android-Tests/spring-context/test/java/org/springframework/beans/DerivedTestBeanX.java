 ...
 * @since 21.08.2003
 */
public class DerivedTestBeanX extends TestBean implements Serializable, BeanNameAware, DisposableBean {
	...
	public DerivedTestBeanX() {
	}

	public DerivedTestBeanX(String[] names) {
