...
public class ExtendedBeanInfoTests {
	...
	public void propertyDescriptorComparator() throws IntrospectionException {
		...
		assertEquals(0, c.compare(new PropertyDescriptor("a", null, null), new PropertyDescriptor("a", null, null)));
		assertEquals(0, c.compare(new PropertyDescriptor("abc", null, null), new PropertyDescriptor("abc", null, null)));
		assertTrue(c.compare(new PropertyDescriptor("a", null, null), new PropertyDescriptor("b", null, null))<0);
		assertTrue(c.compare(new PropertyDescriptor("b", null, null), new PropertyDescriptor("a", null, null))>0);
		assertTrue(c.compare(new PropertyDescriptor("abc", null, null), new PropertyDescriptor("abd", null, null))<0);
		assertTrue(c.compare(new PropertyDescriptor("xyz", null, null), new PropertyDescriptor("123", null, null))>0);
		assertTrue(c.compare(new PropertyDescriptor("a", null, null), new PropertyDescriptor("abc", null, null))<0);
		assertTrue(c.compare(new PropertyDescriptor("abc", null, null), new PropertyDescriptor("a", null, null))>0);
		assertTrue(c.compare(new PropertyDescriptor("abc", null, null), new PropertyDescriptor("b", null, null))<0);

		assertTrue(c.compare(new PropertyDescriptor(" ", null, null), new PropertyDescriptor("a", null, null))<0);
		assertTrue(c.compare(new PropertyDescriptor("1", null, null), new PropertyDescriptor("a", null, null))<0);
		assertTrue(c.compare(new PropertyDescriptor("a", null, null), new PropertyDescriptor("A", null, null))>0);
	}
