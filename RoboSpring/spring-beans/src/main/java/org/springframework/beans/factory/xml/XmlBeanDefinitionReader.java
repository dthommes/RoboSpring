...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	/**
	 * #RoboSpring Because there is no validating parser available on Android
	 * defaulting to disabled validation instead of auto mode.
	 */
	...
	public int getValidationMode() {
		//#RoboSpring return this.validationMode;
	...
	protected int doLoadBeanDefinitions(InputSource inputSource, Resource resource)
		...
		try {
			...
			Document doc = this.documentLoader.loadDocument(
					inputSource, null, this.errorHandler, validationMode, isNamespaceAware());
