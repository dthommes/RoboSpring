...
public class SourceFilteringListener implements SmartApplicationListener {
	...
	public SourceFilteringListener(Object source, ApplicationListener delegate) {
		this.source = source;
		this.delegate = (delegate instanceof SmartApplicationListener ? (SmartApplicationListener) delegate
				: /* #RoboSpring new GenericApplicationListenerAdapter(delegate)) */null);
	}
